...
national_insurance <- national_insurance %>% 
  mutate(est_tot_pop = 
         ...
         est_no_insurance  =
          case_when( check_no_insurance == 1 ~  NA_real_ ,TRUE ~ est_no_insurance))
...
# Renaming columns
national_insurance<- national_insurance %>% rename(Total_Pop= est_tot_pop,
...
> No Insurance refers to the population that do have any kinds of health insurance
