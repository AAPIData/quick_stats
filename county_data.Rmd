...
<div class="btn-group" role="group" aria-label="Basic example">
  <a href="county_data.html#citizen-voting-age-population" type="button" class="btn btn-primary">CVAP</a>
  <a href="county_data.html#education" type="button" class="btn btn-primary">Education</a>
  <a href="county_data.html#limited-english-proficiency" type="button" class="btn btn-primary">LEP</a>
...
county_display_table(county_edu_long, groups_alone,education_percent) %>% formatPercentage(columns = c(3,4,5,6,8,9,10,11), digits = 2) %>% formatCurrency(columns = c(7,12),currency = "", interval = 3, mark = ",", digits=0)
...
county_display_table(county_edu_long, groups_combo,education_percent) %>% formatPercentage(columns = c(3:6, 8:11, 13:16), digits = 2) %>% formatCurrency(columns = c(7,12,17),currency = "", interval = 3, mark = ",", digits=0)
...
datatable(county_cvap_pct, extensions = list("Buttons" = NULL, 'FixedColumns'= T, "Scroller"=T),
              ...
              options = list(
                ...
                buttons = c('copy', 'csv', 'excel'),
                scrollX = TRUE,
                lengthMenu = c(25, 50, 100), pageLength = 50)) %>% formatPercentage(columns = c(3:4), digits = 2)
