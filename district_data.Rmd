...
district_cvap_percent <- district_cvap %>% select(District, State, `AAPI CVAP`, `% AAPI CVAP`, `CVAP Data Available`, `AAPI Pop`, `% AAPI Pop`, `Pop Data Available`) %>% colnames()
...
<div class="btn-group" role="group" aria-label="Basic example">
  ...
  <a href="district_data.html#limited-english-proficiency" type="button" class="btn btn-primary">LEP</a>
  <a href="district_data.html#citizen-age-voting-population" type="button" class="btn btn-primary">CVAP</a>
...
# Citizen Age Voting Population {.tabset .tabset-fade .tabset-pills}
...
Citizen Voting Age Population data is complied using Table ( https://www.census.gov/rdo/data/voting_age_population_by_citizenship_and_race_cvap.html) from the 2015 ACS Special Tabulation 5-year estimates.
