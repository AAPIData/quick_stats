...
avg_aapi_cvap <- state_cvap %>% select(State, `% AAPI CVAP`) %>%  summarize(mean = mean(`% AAPI CVAP`, na.rm=TRUE)) %>% pull() %>% round(.,4)
...
state_cvap_pct <- state_cvap %>% select(State, `% AAPI CVAP`, `% AAPI Pop`) 
