...
highchart() %>%
  ...
  hc_add_series_map(usgeojson, state_pop_map, name = "State Population", value = "asian_pct_totpop", joinBy = c("name", "geodisplaylabel"),
   ...
   hc_tooltip(useHTML=T,pointFormat = "In {point.name}, <span style = 'color:#E26069'>{point.asian_pop:,.0f}</span> Asian Americans <br> make up about <span style = 'color:#E26069'>{point.asian_pct_totpop:.0f}%</span> of the state's <span style = 'color:#E26069'>{point.state_pop_mill:.1f}</span> million residents.") %>%
...
state_cvap_map <- state_cvap_map %>% mutate(
  pct_aapi_statepop = round(est_aapi_pop/est_state_pop*100,2),
...
highchart() %>%
  ...
  hc_add_series_map(usgeojson, state_cvap_map, name = "Citizen Voting Age Population",value = "pct_aapi_cvap", joinBy = c("name", "geoname"),
                    borderColor= "transparent",nullColor = "#bfbfbf") %>%
  hc_tooltip(useHTML=T,pointFormat = "AAPIs make up about <span style = 'color:#E26069'>{point.value:.0f}%</span> of {point.name}'s <br> Citizen Voting Age Population  & <span style = 'color:#E26069'>{point.pct_aapi_statepop:.0f}%</span> of it's resident population.") %>%
  hc_add_theme(hc_theme_538()) %>%
...
state_edu_map <- state_edu_map %>% mutate(
  ...
  pct_asian_bahigher = round(`Asian alone or combo_pct_bahigher`*100,2),
  pct_nhpi_bahigher = round(`NHPI alone or combo_pct_bahigher`*100,2)
)
...
highchart() %>%
  ...
  hc_add_series_map(usgeojson, state_edu_map, name = "Education",value = "pct_asian_bahigher", joinBy = c("name", "geodisplaylabel"),
                    borderColor= "transparent",nullColor = "#bfbfbf") %>%
   hc_tooltip(useHTML=T,pointFormat = "In {point.name}, about <span style = 'color:#E26069'>{point.value:.0f}%</span> of Asian Americans <br> have a BA or higher, compared to the state average of <span style = 'color:#E26069'>{point.pct_state_bahigher:.0f}%</span>.") %>%
  hc_add_theme(hc_theme_538()) %>%
  # hc_colorAxis(stops = color_stops(5),labels= list(format = "{value}%"),showInLegend=T) %>%
  hc_colorAxis(stops= color_stops(n=9, colors =c("#ffffcc","#ffeda0", "#fed976","#feb24c", "#fd8d3c","#fc4e2a","#e31a1c", "#bd0026", "#800026")),labels= list(format = "{value}%"),showInLegend=T) %>%
...
highchart() %>%
  ...
  hc_add_series_map(usgeojson, state_edu_map, name = "Education",value = "pct_nhpi_bahigher", joinBy = c("name", "geodisplaylabel"),
                    borderColor= "transparent",nullColor = "#bfbfbf") %>%
   hc_tooltip(useHTML=T,pointFormat = "In {point.name}, about <span style = 'color:#E26069'>{point.value:.0f}%</span> of NHPIs <br> have a BA or higher, compared to the state average of <span style = 'color:#E26069'>{point.pct_state_bahigher:.0f}%</span>.") %>%
  hc_add_theme(hc_theme_538()) %>%
  hc_colorAxis(stops= color_stops(n=9, colors =c("#ffffcc","#ffeda0", "#fed976","#feb24c", "#fd8d3c","#fc4e2a","#e31a1c", "#bd0026", "#800026")),labels= list(format = "{value}%"),showInLegend=T) %>%
...
state_LEP_map <- state_LEP_map %>% mutate(
  ...
  pct_asian_lep = round(`Asian alone or combo_pct_lep`*100,2),
  pct_nhpi_lep = round(`NHPI alone or combo_pct_lep`*100,2)
)
...
highchart() %>%
  ...
  hc_add_series_map(usgeojson, state_LEP_map, name = "Limited English Proficiency",value = "pct_asian_lep", joinBy = c("name", "geodisplaylabel"),
                    borderColor= "transparent",nullColor = "#bfbfbf") %>%
  hc_tooltip(useHTML=T,pointFormat = "In {point.name}, about <span style = 'color:#E26069'>{point.value:.0f}%</span> of Asian Americans <br> are LEP, compared to the state average of <span style = 'color:#E26069'>{point.pct_state_lep:.0f}%</span>.") %>%
  hc_add_theme(hc_theme_538()) %>%
  hc_colorAxis(stops= color_stops(n=9, colors =c("#ffffcc","#ffeda0", "#fed976","#feb24c", "#fd8d3c","#fc4e2a","#e31a1c", "#bd0026", "#800026")),labels= list(format = "{value}%"),showInLegend=T) %>%
...
highchart() %>%
  ...
  hc_add_series_map(usgeojson, state_LEP_map, name = "Limited English Proficiency",value = "pct_nhpi_lep", joinBy = c("name", "geodisplaylabel"),
                    borderColor= "transparent",nullColor = "#bfbfbf") %>%
  hc_tooltip(useHTML=T,pointFormat = "In {point.name}, about <span style = 'color:#E26069'>{point.value:.0f}%</span> of NHPIs <br> are LEP, compared to the state average of <span style = 'color:#E26069'>{point.pct_state_lep:.0f}%</span>.") %>%
  hc_add_theme(hc_theme_538()) %>%
  hc_colorAxis(stops= color_stops(n=9, colors =c("#ffffcc","#ffeda0", "#fed976","#feb24c", "#fd8d3c","#fc4e2a","#e31a1c", "#bd0026", "#800026")),labels= list(format = "{value}%"),showInLegend=T) %>%
...
state_nativity_map <- state_nativity_map %>% mutate(
  ...
  pct_asian_foreign_born = round(`Asian alone or combo_pct_foreign_born`*100,2),
  pct_nhpi_foreign_born = round(`NHPI alone or combo_pct_foreign_born`*100,2)
)
...
highchart() %>%
  ...
  hc_add_series_map(usgeojson, state_nativity_map, name = "Nativity",value = "pct_asian_foreign_born", joinBy = c("name", "geodisplaylabel"),
                    borderColor= "transparent",nullColor = "#bfbfbf") %>%
  hc_tooltip(useHTML=T,pointFormat = "In {point.name}, about <span style = 'color:#E26069'>{point.value:.0f}%</span> of Asian Americans <br> are Foreign Born, compared to the state average of <span style = 'color:#E26069'>{point.pct_state_foreign_born:.0f}%</span>.") %>%
  hc_add_theme(hc_theme_538()) %>%
  hc_colorAxis(stops= color_stops(n=9, colors =c("#ffffcc","#ffeda0", "#fed976","#feb24c", "#fd8d3c","#fc4e2a","#e31a1c", "#bd0026", "#800026")),labels= list(format = "{value}%"),showInLegend=T) %>%
...
highchart() %>%
  ...
  hc_add_series_map(usgeojson, state_nativity_map, name = "Nativity",value = "pct_nhpi_foreign_born", joinBy = c("name", "geodisplaylabel"),
                    borderColor= "transparent",nullColor = "#bfbfbf") %>%
  hc_tooltip(useHTML=T,pointFormat = "In {point.name}, about <span style = 'color:#E26069'>{point.value:.0f}%</span> of NHPIs <br> are Foreign Born, compared to the state average of <span style = 'color:#E26069'>{point.pct_state_foreign_born:.0f}%</span>.") %>%
  hc_add_theme(hc_theme_538()) %>%
  hc_colorAxis(stops= color_stops(n=9, colors =c("#ffffcc","#ffeda0", "#fed976","#feb24c", "#fd8d3c","#fc4e2a","#e31a1c", "#bd0026", "#800026")),labels= list(format = "{value}%"),showInLegend=T) %>%
