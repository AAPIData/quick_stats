...
highchart() %>%
  ...
  hc_add_series_map(usgeojson, state_pop_map, name = "State Population", value = "asian_pct_totpop", joinBy = c("name", "geodisplaylabel"),
                    borderColor= "transparent",nullColor = "#424242") %>%
...
highchart() %>%
  ...
  # hc_colorAxis(stops = color_stops(5),labels= list(format = "{value}%"),showInLegend=T) %>%
  hc_colorAxis(stops= color_stops(n=9, colors =c("#ffffcc","#ffeda0", "#fed976","#feb24c", "#fd8d3c","#fc4e2a","#e31a1c", "#bd0026", "#800026")),labels= list(format = "{value}%"),showInLegend=T) %>%
  hc_legend(title = list(text= "Asian Alone Percentage", fontStyle ='italic'),align = "center",verticalAlign = "bottom",
            layout = "horizontal", padding = 5) %>% 
  #hc_legend(layout = "vertical", align = "right",
   #         floating = TRUE, valueDecimals = 0, valueSuffix = "%") 
  hc_exporting(enabled = TRUE)
...
highchart() %>%
  ...
  hc_add_theme(hc_theme_538()) %>%
  hc_colorAxis(stops= color_stops(n=9, colors =c("#ffffcc","#ffeda0", "#fed976","#feb24c", "#fd8d3c","#fc4e2a","#e31a1c", "#bd0026", "#800026")),labels= list(format = "{value}%"),showInLegend=T) %>%
  hc_legend(title = list(text= "Asian American Percent Foreign Born", fontStyle ='italic'),align = "center",verticalAlign = "bottom",
            layout = "horizontal", padding = 5) %>% 
  #hc_legend(layout = "vertical", align = "right",
   #         floating = TRUE, valueDecimals = 0, valueSuffix = "%") 
  hc_exporting(enabled = TRUE)
...
highchart() %>%
  ...
  hc_add_theme(hc_theme_538()) %>%
  hc_colorAxis(stops= color_stops(n=9, colors =c("#ffffcc","#ffeda0", "#fed976","#feb24c", "#fd8d3c","#fc4e2a","#e31a1c", "#bd0026", "#800026")),labels= list(format = "{value}%"),showInLegend=T) %>%
  hc_legend(title = list(text= "NHPI Percent Foreign Born", fontStyle ='italic'),align = "center",verticalAlign = "bottom",
            layout = "horizontal", padding = 5) %>% 
  #hc_legend(layout = "vertical", align = "right",
   #         floating = TRUE, valueDecimals = 0, valueSuffix = "%") 
  hc_exporting(enabled = TRUE)
...
highchart() %>%
  ...
  hc_add_theme(hc_theme_538()) %>%
  hc_colorAxis(stops= color_stops(n=9, colors =c("#ffffcc","#ffeda0", "#fed976","#feb24c", "#fd8d3c","#fc4e2a","#e31a1c", "#bd0026", "#800026")),labels= list(format = "{value}%"),showInLegend=T) %>%
  hc_legend(title = list(text= "Asian American Percent Below Poverty", fontStyle ='italic'),align = "center",verticalAlign = "bottom",
            layout = "horizontal", padding = 5) %>% 
  #hc_legend(layout = "vertical", align = "right",
   #         floating = TRUE, valueDecimals = 0, valueSuffix = "%") 
  hc_exporting(enabled = TRUE)
...
highchart() %>%
  ...
  hc_add_theme(hc_theme_538()) %>%
  hc_colorAxis(stops= color_stops(n=9, colors =c("#ffffcc","#ffeda0", "#fed976","#feb24c", "#fd8d3c","#fc4e2a","#e31a1c", "#bd0026", "#800026")),labels= list(format = "{value}%"),showInLegend=T) %>%
  hc_legend(title = list(text= "NHPI Percent Below Poverty", fontStyle ='italic'),align = "center",verticalAlign = "bottom",
            layout = "horizontal", padding = 5) %>% 
  #hc_legend(layout = "vertical", align = "right",
   #         floating = TRUE, valueDecimals = 0, valueSuffix = "%") 
  hc_exporting(enabled = TRUE)
