...
state_pop_map <- state_pop_map %>% mutate(
  state_pop = round(`Total population_est_tot_pop`/1000000, 2),
  asian_pop = round(`Asian alone_est_tot_pop`/1000000, 2),
  nhpi_pop = round(`NHPI alone_est_tot_pop`/1000000, 2))

x <- c("{point.name}:", "Asian Alone:","NHPI Alone:")
title<-"State Population"
y <- c(" {point.value}", " {point.asian_pop}",
" {point.nhpi_pop}")
...
highchart() %>%
  ...
  #hc_legend(layout = "vertical", align = "right",
   #         floating = TRUE, valueSuffix = "million") 
