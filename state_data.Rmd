...
datatable(state_cvap_estimate) %>% formatCurrency(columns = c(2:5),currency = "", interval = 3, mark = ",", digits=0)
```
...
datatable(state_cvap_pct) %>% formatPercentage(columns = c(2:3), digits = 2)
